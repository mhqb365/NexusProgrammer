...
```text
T48.SDK\src\T48Sdk\T48.SDK.csproj
```
...
```xml
<ItemGroup>
  <ProjectReference Include="..\T48.SDK\src\T48Sdk\T48.SDK.csproj" />
</ItemGroup>
```
...
```powershell
dotnet ".\T48.SDK\samples\T48Probe\bin\Debug\net10.0-windows\T48Probe.dll" list
```
